...
The workshop often provides cheat-scripts to ease certain complex tasks.  This helps the class stay focused and reduces the likelyhood of errors and disruptions to the workshop delivery.  Honetsly, we are not here to learn 'vi', 'emacs' or start arguments about the merits of `sed` and `awk`.
