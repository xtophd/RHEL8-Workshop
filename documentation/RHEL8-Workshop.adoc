...
[#toc]
  ...
  . link:{includedir}/systemd.adoc[*SystemD* - (UPDATED) System Service Management] _(node2)_
  . link:{includedir}/firewalld.adoc[*FirewallD* - (UPDATED) Firewall Service Management] _(node2)_
  . link:{includedir}/nftables.adoc[*NFTables* - (NEW) Firewall Subsystem] _(node1)_
  . link:{includedir}/cockpit.adoc[*Cockpit* - (UPDATED) System Management] _(workstation, node2)_
