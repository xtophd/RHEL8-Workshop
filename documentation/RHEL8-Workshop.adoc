...
[#toc]
  ...
  . link:{includedir}/tlog.adoc[Session Logging with Tlog]
  . link:{includedir}/nftables.adoc[Firewall with NFTables]
  . link:{includedir}/cockpit.adoc[Cockpit - System Management]
  . link:{includedir}/stratis.adoc[Stratis - Storage Management Made Easy]
