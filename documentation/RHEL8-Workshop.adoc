...
[#toc]
  ...
  . link:{includedir}/kpatch.adoc[*Kernel Live Patching* - (NEW) Plan Your Reboots] _(node2)_
  . link:{includedir}/ebpf.adoc[*BPF Tracing* - (Updated) Observability of System Performance] _(node2)_
