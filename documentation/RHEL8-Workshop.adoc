...
[#toc]
  ...
  . link:{includedir}/nftables.adoc[NFTables - The New Firewall]
  . link:{includedir}/cockpit.adoc[Cockpit - System Management]
  . link:{includedir}/stratis.adoc[Stratis - Storage Management]
  . link:{includedir}/stratis.adoc[BOOM - Boot Management]
