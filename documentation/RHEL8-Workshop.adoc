...
The workshop often provides scripts to ease certain complex tasks and reduce the chance for errors.  This helps the class stay focused and reduces the likelyhood of disruption to the workshop delivery.  The native commands which the scripts utilize will be documented in the following way.
