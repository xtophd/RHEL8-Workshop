...
Wayland is a replacement for X which is easier to develop and maintain.  Wayland is a compositor protocol and library implementation of that protocol.
...
Many core X contributors are eager to move to the next generation display system - after all Wayland was born and raised in the X community, and has strong support there.
