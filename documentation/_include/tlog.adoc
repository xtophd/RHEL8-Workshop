...
Once you hit enter on the above command, you will see a note that "Playback Started..." and again when "Playback Stopped...".  Be patient until it completes and your root prompt returns.

[NOTE]
====
_Native command(s) to playback tlog_
----
