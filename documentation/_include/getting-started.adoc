...
NOTE:  It is very likely that your instructor (or the automated deployment system) has already performed this step also.  However, there is no harm in performing this action again.
