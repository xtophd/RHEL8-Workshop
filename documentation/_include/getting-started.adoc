...
NOTE: It is likely that your instructor (or the automated deployment system) has already performed these steps.  These steps are provided as an aid in case you are deploying the workshop for the first time, or if steps need to be repeated.
...
NOTE: It is likely that your instructor (or the automated deployment system) has already performed these steps.  There is no harm in rerunning the deployment playbooks.
