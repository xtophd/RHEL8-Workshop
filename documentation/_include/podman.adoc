...
You also need to load the local container registry with a few container images that are stored on configured on core.example.com.  There's a convenient cheat script to take care of this.
