...
Your instructors may provide you with a unique link with special instructions to access the web-console on *https://bastion.example.com* with your local browser. This is the PREFERRED method.
