...
Please note that this activity is required with the RHEL 8 BETA if you change the contents of an AppStream repository.  It has already been executed on the host core.example.com.  This is provided as reference only.
