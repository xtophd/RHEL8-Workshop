...
Leveraging additional network services like pxe, dhcp, kickstart, ansible automation, etc... The process can be heavily automated and turned into a completely hands-free task.  We have doing this for decades.
