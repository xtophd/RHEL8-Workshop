...
Since we have made no real changes to our system, the % of the "exception store" used is still very small.  Let's change that.
...
What the heck, let's anti up and delete some more stuff.  Who need documentation anyway!
