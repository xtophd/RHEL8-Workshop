...
BOOT_IMAGE=(hd0,msdos1)/boot/vmlinuz-4.18.0-147.el8.x86_64 _root=UUID=f7614c41-2835-4125-bb13-50772dc2f30c_ ro console=ttyS0 cons
...
Now we need to get to device (or lvm) path.  Although this logic is not complicated, it's not really the focus of this exercise.  You can inspect the cheat-script for further details.

Run the provided cheat-script.
