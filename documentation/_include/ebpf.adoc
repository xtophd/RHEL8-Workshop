...
On the terminal running tcp-life, go ahead and Ctrl-C the process. You should then be returned to the prompt.
...
Go to the terminal with opensnoop running and issue a Ctrl-C. This will return you to your prompt. That is the expected behavior.
...
Go to the terminal with ext4slower running and issue a Ctrl-C. This will return you to the prompt. That is the expected behavior.
