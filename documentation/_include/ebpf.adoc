...
In this unit, we will get familiar with eBPF. Need to flesh this out more.
...
Now you are ready to begin your exercises with eBPF.
...
Let your session sit open for a few seconds and then run 'exit', thus closing the connection. You should now see on your tcplife window, an entry similar to:
