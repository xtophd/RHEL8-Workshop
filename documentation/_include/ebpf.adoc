...
WARNING: check which filesystem you host is using with `df -T /`.  If you host is configured with ext4, then substitute the command *ext4slower* in place of *xfsslower*.
