...
Let's open another workstation terminal session. To do that, from tmux, hit `Ctrl+b` then the `"` key. This should split the window in two and give you a new root session on node2. Now you need to run:
