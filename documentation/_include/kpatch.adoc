...
----
[root@node2 ~]# yum install "kpatch-patch = $(uname -r)" -y
...
----
[root@node2 ~]# rpm -qi --changelog kpatch-patch-4_18_0-147
----
...
----
[root@node2 ~]# yum update kernel -y
Updating Subscription Management repositories.
...
[root@node2 ~]# rpm -q kernel
kernel-4.18.0-147.el8.x86_64
